...
export PKG_CONFIG_LIBDIR="$M_CROSS/mingw/opt/lib/pkgconfig"
...
cmake .. -G Ninja \
  -DCMAKE_INSTALL_PREFIX=$M_CROSS/mingw/opt \
...
CHOST=$MINGW_TRIPLE ./configure --prefix=$M_CROSS/mingw/opt --static
make -j$MJOBS
make install
